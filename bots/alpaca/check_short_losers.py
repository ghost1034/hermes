...
for symbol, sym_orders in trades.items():
    ...
    is_long = sym_orders[0].side.value == 'buy'
        ...
        for o in sym_orders:
            if o.filled_avg_price and o.filled_qty:
                ...
                if o.side.value == 'buy':
                    ...
                    cash_flow += val
        short_pnl_by_symbol[symbol] = cash_flow

sorted_pnl = sorted(short_pnl_by_symbol.items(), key=lambda x: x[1])

print("Top 5 Short Losers:")
